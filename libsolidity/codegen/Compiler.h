...
{
public:
Compiler(langutil::EVMVersion _evmVersion, RevertStrings _revertStrings, OptimiserSettings _optimiserSettings, langutil::ErrorReporter& _errorReporter):		m_optimiserSettings(std::move(_optimiserSettings)),
